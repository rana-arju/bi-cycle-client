    ...
    return (
        ...
        <div className=' grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5'>
            ...
            <div className="card-body">
                <h2 className="card-title">Cycling for health and fitness</h2>
                ...
                <button className="btn btn-primary btn-block">Read More</button>
                </div>
            </div>
            </div>
        ...
        {/* Blog/Article 2 */}
            ...
            <div className="card-body">
                <h2 className="card-title">Cardiovascular disease and cycling</h2>
        ...
        {/* Blog/Article 3 */}
            ...
            <div className="card-body">
                <h2 className="card-title">Health benefits of regular cycling</h2>
