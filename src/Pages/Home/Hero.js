...
const Hero = () => {
    ...
    return (
        <div className="hero h-[350px] md:h-[550px] w-full" style={{backgroundImage: `url(https://i.ibb.co/6RMg2J8/pexels-tony-990113-1.jpg)`,backgroundSize: "cover", backgroundPosition: "center center"}}>
